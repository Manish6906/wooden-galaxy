    ...
    <>
      <div className="relative">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
          <p className="font-medium text-2xl md:text-5xl font-poppins md:h-[72px] md:w-[233px]">CheckOut</p>
          <p className="text-sm">
      ...
      <div className="mt-60 ml-44 mr-36 lg:flex">
        <div className="flex-none w-[608px]  top-[479px] left-[734px] ">
          ...
          <form action="#" method="post">
            ...
            <div className="mt-8">
              <label className="mt-5 font-medium">Company Name (Optional)</label>
              <input
                type="text"
            ...
            <div className="mt-8">
            <label className="mt-5 font-medium">Country / Region</label> <br />
              <select name="" id="" className="border-black border-2 opacity-50 rounded-md h-[75px]  mt-2 w-[453px] md:mt-5">
                <option value="">Sri Lanka</option>
              </select>
            </div>
            <div className="mt-8">
            <label className="mt-5 font-medium">Street address</label><br />
              <input
                type="text"
                className="border-black border-2 opacity-50 rounded-md h-[75px]  mt-2 w-[453px] md:mt-5 "
              />
            ...
            <div className="mt-8">
            <label className="mt-5 font-medium">Town / City</label><br />
              <input
                type="text"
                className="border-black border-2 opacity-50 rounded-md h-[75px]  mt-2 w-[453px] md:mt-5 "
              />
            ...
            <div className="mt-8">
            <label className="mt-5 font-medium">Province</label><br />
            <select name="" id="" className="border-black border-2 opacity-50 rounded-md h-[75px]  mt-2 w-[453px] md:mt-5">
                <option value="" >Western Province</option>
              </select>
            </div>
            <div className="mt-8">
            <label className="mt-5 font-medium">ZIP Code</label><br />
              <input
                type="text"
                className="border-black border-2 opacity-50 rounded-md h-[75px]  mt-2 w-[453px] md:mt-5 "
              />
            ...
            <div className="mt-8">
            <label className="mt-5 font-medium">Phone</label><br />
              <input
                type="text"
                className="border-black border-2 opacity-50 rounded-md h-[75px]  mt-2 w-[453px] md:mt-5 "
              />
            ...
            <div className="mt-8">
            <label className="mt-5 font-medium">Email Address</label><br />
              <input
                type="text"
                className="border-black border-2 opacity-50 rounded-md h-[75px]  mt-2 w-[453px] md:mt-5 "
              />
        ...
        <div className="flex gap-80">
            <div>
              ...
              <h1 className="mt-4 font-medium">Subtiotal</h1>
              <h1 className="mt-4 mb-4 font-medium">Total</h1>
            </div>
            <div >
          ...
          <hr />
          <div>
            <input type="radio" name="radio" className="mt-3 font-medium"/>   Direct Bank Transfer
           ...
           <div className="opacity-50">
            ...
            <p className="mt-4 font-medium tracking-wider font-poppins">Your personal data will be used to support your experience throughout this website, to manage access to your account, and for other purposes described in our <span className="font-bold leading-[24px]">privacy policy.</span></p>
          </div>
