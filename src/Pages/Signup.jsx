                    ...
                    <div className='mt-4'>
                        <form action="" method="post" className='md:px-8'>
                            <div className="flex gap-4 px-3">
                                <div className=''>
                                    <label className="block px-3 text-lg text-[#444B59]" htmlFor="username">First Name</label>
                                    <input type="text" id="username" className="w-full border-2 border-[#B5B0AB] h-1/2 p-4 rounded-full md:h-14 outline-[#8f8b86]" />
                                </div>
                                <div>
                                    <label className="block px-3 text-lg text-[#444B59]" htmlFor="username">Last Name</label>
                                    <input type="text" id="username" className="w-full border-2 border-[#B5B0AB] h-1/2 p-4 rounded-full md:h-14 outline-[#8f8b86]" />
                                </div>
                            </div>
                            <div className="mb-4 mt-4 px-3">
                                <label className="block px-3 text-lg text-[#444B59]" htmlFor="password">Enter Mobile Number</label>
                                <input type="number" id="password" className="w-full border-2 border-[#B5B0AB]  h-1/2 p-4 rounded-full md:h-14 outline-[#8f8b86]" />
                            </div>

                            <div className="mb-4 px-3">
                                <label className="block px-3 text-lg text-[#444B59]" htmlFor="password">Email address</label>
                                <input type="email" id="password" className="w-full border-2 border-[#B5B0AB]  h-1/2 p-4 rounded-full md:h-14 outline-[#8f8b86]" />
                            </div>
                            <div className="mb-4 px-3">
                                <label className="block px-3 text-lg text-[#444B59]" htmlFor="password">Choose Password</label>
                                <input type="password" id="password" className="w-full border-2 border-[#B5B0AB]  h-1/2 p-4 rounded-full md:h-14 outline-[#8f8b86]" />
                            </div>
                            <div className="mb-4 px-3">
                                <label className="block px-3 text-lg text-[#444B59]" htmlFor="password">Confirm Password</label>
                                <input type="password" id="password" className="w-full border-2 border-[#B5B0AB]  h-1/2 p-4 rounded-full md:h-14 outline-[#8f8b86]" />
                            </div>

                            {/* SIGN IN Button  */}
                            <div className='flex justify-center'>
                                <button className="w-1/2 border-2 p-2 mt-4 rounded-full outline-none text-[white] border-[#B5B0AB] md:h-14 bg-[#B5B0AB]">SUBMIT
                                </button>
                            </div>
