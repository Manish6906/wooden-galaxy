...
const Single_product = () => {
  return (
    < >
      ...
      <div className='h-24 flex items-center justify-center sm:flex sm:justify-start sm:items-center bg-[#F9F1E7]  '>
        ...
        <div className='flex items-center gap-3 sm:gap-6  sm:ml-24'>
          ...
          <div className='h-7 border-[1px] border-[#9F9F9F] hidden sm:block'></div>
          <p className=' font-medium sm:font-semibold'>Asgaard sofa</p>
      ...
      <div className='flex flex-col justify-center sm:flex sm:flex-col sm:justify-center 
       md:flex md:flex-col md:justify-center lg:flex lg:flex-row lg:justify-evenly gap-10 lg:gap-24 mb-7 w-full'>


{/*   LEFT SIDE */} 

        <div className='flex justify-center pt-0 lg:pt-9 ml-0 sm:ml-20 mt-7 '> 
...
{/* right side code */}
        ...
        <div className='ml-2 mb-2 mr-2 mt-7'>
          <div>
          <div className=' text-[42px] mb-[3px] '>
            Asgaard sofa
          </div>
          ...
          <div className='flex gap-4 mb-4'>
            <button className='h-[30px] w-[30px] rounded-[5px] bg-[#B88E2F] text-center'>L</button>
            <button  className='h-[30px] w-[30px] rounded-[5px] bg-[#F9F1E7] text-center'>XL</button>
            <button className='h-[30px] w-[30px] rounded-[5px] bg-[#F9F1E7] text-center'>XS</button>
          </div>
          ...
          <div className='mt-[50px] flex flex-wrap justify-center  sm:flex sm:justify-start gap-3 mb-[30px]'>
              ...
              <div>
                <button className="w-[215px] h-[65px] text-lg font-semibold border-[#000000] border-[1px] rounded-[10px] flex justify-evenly items-center hover:bg-yellow-700
                hover:text-white">Add To Cart</button>
              </div>
          ...
          <div className='text-[#9F9F9F] mt-5 leading-9'>
            ...
            <div className='flex items-center gap-1 '>
              ...
              <div className='flex gap-2 sm:gap-5 text-black'>
                <div>
                  <Link to="Link"><FaFacebook /></Link>
                </div>
                <div>
                <Link to="Link"><FaLinkedin /></Link>                 
                </div>
                <div>
                <Link to="Link"><FaTwitter /></Link>
                </div>
              </div>
     ...
     <div className=' flex justify-center gap-8 my-12'>
        <p className='text-2xl font-medium underline text-center'>Description</p>
        <Link to="Link"><p className='text-2xl text-[#9F9F9F] hidden sm:block'>Additional Information</p></Link>
        <Link to="Link"><p className='text-2xl text-[#9F9F9F] hidden sm:block'>Reviews[5]</p></Link>
      </div>
     ...
     <div className='flex justify-center'>
      ...
      <div className='flex flex-col  sm:flex sm:flex-row sm:justify-center gap-5  mt-4 mb-14'>
